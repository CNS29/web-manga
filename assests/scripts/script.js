...
window.onclick = (e) => {
    if(!e.target.closest(".nav__noitification")) { 
        if(!document.querySelector(".noitification__content").classList.contains("disable")) {
            document.querySelector(".noitification__content").classList.add("disable");
        }
    }
}
    ...
    if(document.body.scrollTop > 50) {
        ...
        if(screen.width > 767) {
            if(isScroll > window.pageYOffset) {
                ...
                document.querySelector(".header__nav-category").classList.add("header__nav-category--fixed");
        ...
        document.querySelector(".header__nav-category").classList.remove("header__nav-category--fixed");
    }
}
...
nav.onclick = (e) => {
    ...
    if(!choose.classList.contains("main__item--active")) {
        nav.querySelector(".main__item--active").classList.remove("main__item--active");
